 ...
 */
public class CustomerRepositoryTestSame extends AbstractRepositoryTest{
    ...
    public void shouldFindAllCustomer() {
        ...
        assertThat(customerEntityList.get(0).getName(), is("lol_same"));
    }


    @Override
    protected String getTestChangelog() {
        return "customer_change_data_same.xml";
    }
